...
class main ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.Baudrate_cmb = wx.ComboBox( self.m_panel1, wx.ID_ANY, u"9600", wx.DefaultPosition, wx.DefaultSize, Baudrate_cmbChoices, 0 )  #pjh
		# self.Baudrate_cmb.SetSelection( 3 )
		self.Baudrate_cmb.SetSelection( 6 ) #pjh
